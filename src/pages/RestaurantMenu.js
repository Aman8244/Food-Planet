    ...
    return (
        <>
            ...
            {(restaurant && restaurant.info) ?
                <div className=" ml-40 mt-14 mb-5 mr-40">
                    <div>
                        <div>
                        ...
                        <div className='card rounded-xl border-r-1 pb-2 mb-8  border-l-1 border-b-1 bg-gradient-to-b from-white to-gray-200'>
                            <div className='card m-4 pb-4 pt-2 border-r-2 border-l-2 border-gray-200 border-b-2 rounded-xl bg-white'>
                    ...
                    <div>
                        <Link to={`/search/menu/${restaurant.info.id}`}>
                            <div className='rounded-xl flex flex-row pt-4 pb-4 mt-4 mb-4 ml-0 mr-0 text-gray-600 bg-gray-200'>
                                <div className='mr-2 ml-24 w-80 flex flex-row-reverse'>
